    ...
    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            <flux:navlist.group :heading="__('Platform')" class="grid">
                <flux:navlist.item icon="shopping-bag" :href="route('shop')" :current="request()->routeIs('shop')"
                    wire:navigate>{{ __('Shop') }}</flux:navlist.item>
            </flux:navlist.group>
            ...
            <flux:navlist.group :heading="__('Management Tools')" class="grid">
                <flux:navlist.item icon="user-circle" :href="route('users')" :current="request()->routeIs('users')"
                    wire:navigate>{{ __('Users') }}</flux:navlist.item>

                <flux:navlist.item icon="archive-box" :href="route('products')"
                    :current="request()->routeIs('products')" wire:navigate>{{ __('Products') }}</flux:navlist.item>

                <flux:navlist.item icon="adjustments-horizontal" :href="route('categories')"
                    :current="request()->routeIs('categories')" wire:navigate>{{ __('Categories') }}</flux:navlist.item>

                <flux:navlist.item icon="check-badge" :href="route('brands')" :current="request()->routeIs('brands')"
